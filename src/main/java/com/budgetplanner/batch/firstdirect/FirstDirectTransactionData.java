...
public class FirstDirectTransactionData extends TransactionData {

	private static final Logger log = LoggerFactory.getLogger(FirstDirectTransactionData.class);
